...
public class ReminderActivity extends AppCompatActivity {
    ...
    Button mSubmitbtn, mDatebtn, mTimebtn,addp,keyp;
    EditText mTitledit;
    String timeTonotify;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Schedule Alarm");
    ...
    public void openActivity3(){
        Intent intent =new Intent(this,ProtecterActivity.class);
        startActivity(intent);

    }
    public void openActivity4(){
        Intent intent =new Intent(this,DisplayToken.class);
        startActivity(intent);
    ...
    private void setAlarm(String text, String date, String time) {
        ...
        Intent intentBack = new Intent(getApplicationContext(), RemainderActivity.class);                //this intent will be called once the setting alaram is completes
